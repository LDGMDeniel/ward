...
'<a href="list.php">Клиенты</a>',//2
'<a href="list.php?t=man">Контакты</a>',//3
'<a href="taskman.php">Задачи</a>',//4
'<a href="info.php"><span id="t_gray">Карточка</span></a>',//5
'<a href="../login.php?a=q">Выход</a>');//6
switch($page){
 ...
 case '/CRM/info.php':$links[5]='<span id="t_gray">Карточка</span>'; break;
}
